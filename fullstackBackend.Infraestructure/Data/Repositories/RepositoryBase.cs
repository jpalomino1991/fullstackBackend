...
namespace fullstackBackend.Infraestructure.Data.Repositories
{
   public class RepositoryBase<T> : IAsyncRepository<T> where T : BaseEntity
   {
      ...
      protected readonly EmployeeContext DbContext;
      ...
      {
         return PropertiesToInclude.Any() ? await AllIncluding(PropertiesToInclude).AsNoTrackingWithIdentityResolution().FirstOrDefaultAsync(expression) : await DbSet.AsNoTrackingWithIdentityResolution().FirstOrDefaultAsync(expression);
      }
